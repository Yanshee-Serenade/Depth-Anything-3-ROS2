...
class TestDA3InferenceWrapper(unittest.TestCase):
    ...
    def test_inference_invalid_input_type(self):
        ...
        with patch('depth_anything_3_ros2.da3_inference.torch'):
            with patch('depth_anything_3_ros2.da3_inference.DepthAnything3'):
                from depth_anything_3_ros2.da3_inference import DA3InferenceWrapper

                # This would normally fail during model loading, but we'll test
                # the validation logic separately if we can instantiate
                pass
